    ...
    <>
      <div class="container px-4 text-left">
        <div class="row gx-5">
          ...
          <div class="col">
            <div class="p-3">
              <img src="https://images.unsplash.com/photo-1622896784083-cc051313dbab?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MTd8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=800&q=60" alt="" />
            </div>
          </div>
        </div>
      </div>
      <div class="container px-4 text-left">
        <div class="row gx-5">
          <div class="col">
            <div class="p-3">
              <img src="https://images.unsplash.com/photo-1627834377411-8da5f4f09de8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MTV8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=800&q=60" alt="" />
            </div>
          </div>
          <div class="col">
            <div class="p-3">
              ...
              <p>
                ...
                make others like you have an enjoyable and rememberable
              ...
              <p>
                 So if your looking for a cake or treats for your special occasion, Boujie
                Delights can help make your day a remarkable. I looking forward
                to hearing from you soon!
              </p>
            </div>
