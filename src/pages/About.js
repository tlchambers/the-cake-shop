				...
				<div className="row gx-5">
					...
					<div className="col">
						<div className="p-3">
							...
							<p>
								My aspiration is to make tasteful, beautifully baked and
								visually pleasing cakes. Futhermore to provide a enjoyable and
								memorable experience for everyone who tastes my creations. So if
								your looking for a cake or treats for your special occasion,
