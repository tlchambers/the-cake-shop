  ...
  return (
    <>
       <Banner
        ...
        paragraph="Boujie Delights specialises in creating bespoke cakes that are tailored to customers' specific needs. From weddings to birthdays, and everything in between. Offering a wide range of flavours, fillings, and decorations ensures that your cake perfectly matches your vision. Freshly baked buttercream cakes, cupcakes, and treats are not only delicious, but also visually pleasing. Located in Brockley, South East London. "
      />
      <Cards />
    </>
  );
