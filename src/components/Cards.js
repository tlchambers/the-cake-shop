    ...
    return (
      <div className="container-fluid d-flex justify-content-center">
        <div className="row">
          <div className="col-sm-4">
            <a href="/collections/cakes" class=".stretched-link">
              <Card
                ...
                title="BESPOKE CAKES" text="If you’re looking for a beautiful handmade cake for any occasions, you’ve come to the right place."
                shopNow="SHOP NOW >"
              />
            </a>
          </div>
          <div className="col-sm-4">
            <a href="/collections-cupcakes" class=".stretched-link">
              <Card
          ...
          <div className="col-sm-4">
            <a href="/collections-mini-cakes" class=".stretched-link">
              <Card
